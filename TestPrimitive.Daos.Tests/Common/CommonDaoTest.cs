...
namespace TestPrimitive.Daos.Tests.Common
{
	...
	where TDdlBuilder : DdlBuilder, new()
	{
		...
		public void BasicSetUp()
		{
			...
			DaoFactory.Instance.ConnectionStringBuilder = new SqlCeConnectionStringBuilder("TestPrimitive.Entities", baseDirectory, null);
